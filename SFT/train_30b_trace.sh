...
if [[ -n "${OPENSEARCH_DIAGNOSTIC_V1_KERNEL_IDS:-}" ]]; then
  set_debug_yaml_scalar v1_kernel_ids "${OPENSEARCH_DIAGNOSTIC_V1_KERNEL_IDS}"
fi
...
echo "       OPENSEARCH_DIAGNOSTIC_V1_KERNEL_IDS: ${OPENSEARCH_DIAGNOSTIC_V1_KERNEL_IDS:-<source yaml>}"
